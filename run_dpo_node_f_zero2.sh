...
WD=0.1
BETA=0.1
NAME=llama-3.1-swallow-instruct-v0.2_dpo_${DATASET_NAME}_adamw_0.95_LR_${LR}_MINLR_${MINLR}_WD_${WD}_BETA_${BETA}_EPOCH_2_zero2


accelerate launch --config_file configs/my_accelerate_config_zero2.yaml train_llm_dpo.py --output_dir /gs/bs/tga-okazaki/$USER/$NAME \
--run_name $NAME \
